...
export function ComponentRegistryClient({
  ...
  return (
    <GsapRevealScope animationKey={registryAnimationKey}>
      <section
      ...
      >
        <div
          data-gsap-reveal
          className="flex flex-col gap-3 border-b border-[var(--border)] pb-5 lg:flex-row lg:items-end lg:justify-between"
        >
          <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(event) =>
                  updateCategory(
                    event.target.value as ComponentCategory | "all",
                  )
                }
                className="mt-2 min-h-12 w-full rounded-2xl border border-[var(--border)] bg-black/35 px-4 text-sm text-[var(--foreground)] outline-none focus:border-[var(--turquoise)]"
              >
